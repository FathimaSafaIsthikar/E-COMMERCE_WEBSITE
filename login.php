								...
								<form id="login-form" method="post">
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="login_email" id="login_email" placeholder="Your Email*" style="width:100%" required>
										</div>
						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="register-form" method="post">
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="user_register()" name="register"  id="btn_register">Register</button>
									</div>
								</form>
